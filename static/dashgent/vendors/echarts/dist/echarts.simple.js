...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    /**
	     * Prepare view instances of charts and widgets
	    ...
	    echartsProto._initEvents = function () {
	        each(MOUSE_EVENT_NAMES, function (eveName) {
	            this._zr.on(eveName, function (e) {
	                ...
	                // If element has custom eventData of widgets
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // name can be duplicated among widgets, which is convenient
	        // to specify multi widgets (like series) by one name.
