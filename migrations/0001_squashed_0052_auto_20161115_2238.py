    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions_to_view', models.ManyToManyField(to=b'auth.Group')),
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, to=b'auth.Group'),
        ),
        migrations.AlterField(
            model_name='page',
            name='text',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions_to_view', models.ManyToManyField(blank=True, help_text='Specifies the groups that may view this widget', to=b'auth.Group')),
        ...
        migrations.AlterField(
            model_name='page',
            name='permissions_to_view',
            field=models.ManyToManyField(blank=True, help_text='Specifies the groups that may view this page', to=b'auth.Group'),
        ),
        migrations.AlterField(
            model_name='page',
            name='text',
        ...
        migrations.AddField(
            model_name='navigationsection',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='navigation_sections', to=b'uc_dashboards.Tag'),
        ),
        migrations.AddField(
            model_name='page',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='pages', to=b'uc_dashboards.Tag'),
        ),
        migrations.AddField(
            model_name='template',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='templates', to=b'uc_dashboards.Tag'),
        ),
        migrations.AddField(
            model_name='widget',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='widgets', to=b'uc_dashboards.Tag'),
        ),
        migrations.CreateModel(
            name='GroupProfile',
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='group_profiles', to=b'uc_dashboards.Tag')),
                ...
                ('perspectives', models.ManyToManyField(blank=True, related_name='group_perspectives', to=b'uc_dashboards.Perspective')),
            ],
        ),
        migrations.AlterField(
            model_name='template',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, help_text='Any comment.')),
                ('pages', models.ManyToManyField(blank=True, help_text='The pages that are part of this perspective.', related_name='perspectives', to=b'uc_dashboards.Page')),
                ('tags', models.ManyToManyField(blank=True, related_name='perspectives', to=b'uc_dashboards.Tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preset_filters', models.TextField(blank=True, help_text='Can set preset filters for perspectives. Filters will be applied onto perspectives')),
                ('comment', models.TextField(blank=True, help_text='Any comment.')),
                ('tags', models.ManyToManyField(blank=True, related_name='user_profiles', to=b'uc_dashboards.Tag')),
